...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() throws Exception {
		...
		//access the private getCat method using Java reflection
	...
	public void testGetCatNumCats3() throws Exception{
        ...
        //invoke the method to get the cat with ID 2
        Cat result = (Cat) getCatMethod.invoke(r, 2);
        
        //check the return value
        assertNotNull(result);
        assertEquals(c2.getId(), result.getId());
	}
	...
	public void testRentCatNumCats3() {
		...
		//vertify that methods are called
	...
	public void testRentCatFailureNumCats3() {
		...
		//vertify that never call the method
